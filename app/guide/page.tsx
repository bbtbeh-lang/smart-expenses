    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'ul', items: [
          ...
          'A Processing Queue for receipts still being read by AI in the background.',
    ...
    },
    {
      ...
      blocks: [
        { type: 'ul', items: [
          ...
          'Preferences — daily reminder notifications, base currency.',
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'ul', items: [
          ...
          'صف پردازش — برای رسیدهایی که هنوز پشت‌صحنه توسط هوش مصنوعی خونده می‌شن.',
    ...
    },
    {
      ...
      blocks: [
        { type: 'ul', items: [
          ...
          'ترجیحات — یادآوری روزانه، ارز پایه.',
