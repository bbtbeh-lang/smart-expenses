      ...
      <div className="relative w-full max-w-lg bg-white rounded-t-3xl shadow-2xl z-50 max-h-[92vh] overflow-y-auto">
        ...
        <div className="px-5 pb-8 pt-2" id="tax-report-pdf-content">
            ...
            <div className="space-y-2">
              {transactions.length === 0 ? (
                ...
                transactions.slice().reverse().map(tx => (
                  <div key={tx.id} className="flex items-center gap-3 bg-slate-50 rounded-xl p-3">
          ...
          <div className="mt-6 space-y-3">
            ...
            {tier === 'premium' ? (
              <button className="w-full py-3.5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl text-sm shadow-lg shadow-emerald-200 flex items-center justify-center gap-2">
